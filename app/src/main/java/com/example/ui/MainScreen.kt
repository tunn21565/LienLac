    ...
    Scaffold(
        ...
        bottomBar = {
            NavigationBar(
                ...
                // Tab 3: School Requests
                NavigationBarItem(
                    selected = selectedTabIndex == 3,
                    onClick = { selectedTabIndex = 3 },
                    icon = {
                        Icon(
                            if (selectedTabIndex == 3) Icons.Default.NotificationImportant else Icons.Outlined.NotificationImportant,
                            contentDescription = "Yêu cầu"
                        )
                    },
                    label = { Text("Yêu cầu", fontSize = 11.sp) },
                ...
                NavigationBarItem(
                    ...
                    icon = {
                        Icon(
                            ...
                            contentDescription = "Kết quả"
                        )
                    },
                    label = { Text("Kết quả", fontSize = 11.sp) },
